  ...
  return (
    <>
      ...
      <div
        className={`${
          isScrolled
            ? "bg-white text-black shadow-lg flex flex-col justify-between p-4 py-4 px-4 sm:px-4 md:px-32 lg:px-36"
      ...
      >
        ...
        <div className="flex flex-col md:flex-row lg:flex-row mt-4 border-t">
