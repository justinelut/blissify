...
export default function SidePanel() {
  return (
    <div className="hidden text-blue text-3xl border-r border-gray-300 h-screen lg:w-1/5 md:w-3/4 sm:w-3/4 w-full p-4 lg:flex lg:flex-col md:flex md:flex-col">
